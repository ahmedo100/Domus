...
String noel3_contenu  = "for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e3")) appareil.appliquer("allumer");";
CScenario noel3= new CSenario("noel3",noel3_contenu);
ma_liste_scenarios.add(noel3);
String noel2_contenu  = "for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e2")) appareil.appliquer("allumer");";
CScenario noel2= new CSenario("noel2",noel2_contenu);
ma_liste_scenarios.add(noel2);
String noel1_contenu  = "for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e1")) appareil.appliquer("allumer");   
 this.execScenarioNum(1);  
";
CScenario noel1= new CSenario("noel1",noel1_contenu);
ma_liste_scenarios.add(noel1);
String depart_contenu  = "System.out.println("Affichage console :Scenario D�part  ");
for(CAppareil appareil : this.l_appareils)
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("v")) appareil.appliquer("fermer")for(CAppareil appareil : this.l_appareils)
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e")) appareil.appliquer("eteindre")for(CAppareil appareil : this.l_appareils)
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("x")) appareil.appliquer("eteindre")for(CAppareil appareil : this.l_appareils)
  if (appareil.getNomAppareil().equals("fen"))
if (appareil.etatAppareil.equals(TypeEtatAppareil.FERME))
    {
for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("a1")) appareil.appliquer("allumer");else{System.out.println("Affichage console :Attention : la fenêtre ,fen, est ouverte !  ");
}";
CScenario depart= new CSenario("depart",depart_contenu);
ma_liste_scenarios.add(depart);
String soiree_musique_contenu  = "   
 this.execScenarioNum(1);  
for(CAppareil appareil : this.l_appareils)
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e")) appareil.appliquer("allumer")";
CScenario soiree_musique= new CSenario("soiree_musique",soiree_musique_contenu);
...
String soiree_contenu  = "for(CAppareil appareil : this.l_appareils)
 ...
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("e")) appareil.appliquer("allumer")";
CScenario soiree= new CSenario("soiree",soiree_contenu);
ma_liste_scenarios.add(soiree);
String bonjour_contenu  = "for(CAppareil appareil : this.l_appareils)
 for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("v")) appareil.appliquer("ouvrir")for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("a1")) appareil.appliquer("eteindre");for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("cafe")) appareil.appliquer("allumer");for(CAppareil appareil : this.l_appareils)
  if (appareil.getNomAppareil().equals("rad1"))
if (appareil.etatAppareil.equals(TypeEtatAppareil.ETEINT))
    
for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("rad1")) appareil.appliquer("allumer");for(CAppareil appareil : this.l_appareils)
 appareil.getNomAppareil().equals("hf")) appareil.appliquer("allumer");";
CScenario bonjour= new CSenario("bonjour",bonjour_contenu);
